...
#### _- What is the motivation of mentors to mentor?_
...
#### _- Do we cooperate with IT companies in any way?_
...
#### _- Can I only complete the course assignments on weekends?_
...
#### _- What is the best way to ask questions?_
...
#### _- Is the Telegram chat moderated?_
...
#### _- When and how are the meetings conducted?_
...
#### _- Will the meetings be recorded?_

No, we usually don't record meetings. So, ensure you don't miss them.

#### _- What should I do if my contact information has changed?_
...
#### _- Should I answer theoretical questions in PR?_
...
#### _- How do I start completing tasks?_
...
#### _- How and where do I send Pull Requests of completed tasks?_
...
#### _- When is a task considered completed?_
...
#### _- How do mentors distinguish between finished Pull Requesters and unfinished Pull Requesters?_
...
#### _- Should I open an unfinished PR?_
...
#### _- How many mentors need to approve before bot can merge?_
...
#### _- Where should I answer the questions in the first chapter?_

You can provide the answers under each question by editing your own md-file.

#### _- What should I do if I find mistakes in the repository?_

We encourage you to open an __issue__ if you see any problems.

#### _- How can I incorporate changes from the main repository?_
...
_If you get the error `fatal: refusing to merge unrelated histories` add option `--allow-unrelated-histories` flag to the last command._
...
#### _- What to do if you merged with `--allow-unrelated-histories`, but there are too many merge conflicts?_

1. You need to restore the state of your repository before the unsuccessful merge.

Because of how `--allow-unrelated-histories` merges commits, the only actual way to do so is to make a brand new clone of your repository from the state it was saved on your GitHub.
...
#### _- I can't choose my capstone project. Can you suggest some?_
