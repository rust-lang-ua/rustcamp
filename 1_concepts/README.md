...
- 🧭 [Rustonomicon: Subtyping and Variance][13]⏱0.5h
...
Provide your own implementation of 📰 [doubly linked list][11] data structure. It should be 📰 [thread safe][12]⏱0.25h without a necessity to use explicit synchronization primitives (like `Arc<Mutex<T>>`) on top of it.
