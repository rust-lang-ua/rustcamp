...
🏠 [Rust] has 📚 [`Send`] and 📚 [`Sync`] marker traits which are fundamental for concurrency and thread safety story in 🏠 [Rust] and represent one of 🧭 [fearless concurrency][2]⏱0.25h corner stones (which allow to 🧭 [avoid data races][1]⏱0.25h at compile time).
