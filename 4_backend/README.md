...
2. What should I use for 📰 [HTTP]⏱1.5h server implementation in 🏠 [Rust], when and why? What about 📰 [WebSocket]⏱1h connections?
...
- Use 🧭 [dataloading][22] to optimize interaction with database in 📰 [GraphQL]⏱0.25h resolvers. 
