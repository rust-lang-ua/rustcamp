...
Rework the application [from the previous task](../4_3_api/README.md#task) by introducing 🏠 [gRPC] as an 📰 [API] between the 📰 ["thick client"][41]⏱0.25h and the server, while preserving the 📰 [REST]⏱0.25hful [API]:
...
- it should be still possible to perform all the operations via 📰 [cURL] (or any other 📰 [HTTP]⏱1.5h/📰 [API] client) directly on the 📰 [REST]⏱0.25hful 📰 [API] server.
